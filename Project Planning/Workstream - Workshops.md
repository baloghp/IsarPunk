...
- [ ] Pitch one-pager for teachers / Schulleitung
- [ ] Ask for a **2-hour slot** (88 min content + chaos buffer); 90 min is a workable fallback
- [ ] Workshop #1 date locked
- [ ] Dates sketched for #2–#6
- [ ] Room needs confirmed per venue: tables for teams, wall/floor space, **power at both station tables** (assume no usable Wi‑Fi)
- [ ] Second facilitator confirmed per date (**hard requirement** — the two stations run in parallel)
...
| E-waste + Save Oma | Narrative §1 | not started |
| Linux / FOSS myth-bust | Narrative §2 | not started |
| Why revive (GPU/RAM / skills) | Narrative §3 | not started |
| What we ask / partner handoff | Narrative §4 | not started |
| Demo / Live USB | TBD | not started |
| Confidence close + stickers/form | Metrics from minutes | not started |

---

## School / venue pipeline

| School / community | Contact | Status | Target month | Notes |
|--------------------|---------|--------|--------------|-------|
| | | researching | Nov | |
| | | researching | | |
| | | researching | | |

**Status values:** `researching` · `pitched` · `interested` · `date proposed` · `confirmed` · `done` · `declined`

---

## Delivery log

| # | Date | Place | ~N youth | Confidence method | Partners named | Platform team seeded? | Retro (1 line) |
|---|------|-------|----------|-------------------|----------------|-----------------------|----------------|
| 1 | | | | | | | |
| 2 | | | | | | | |
| 3 | | | | | | | |
