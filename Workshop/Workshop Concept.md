...
| Beat | Artifacts |
|------|-----------|
| 1 Primer | Layer-sort cards · personal colours |
| 2 / 7 Measure | One Measure sheet (opinions + confidence) |
| 3 Stations | 2 laptops · USBs · F1 / F2 |
| 4 Win10 talk | — |
| 5 Save Oma | A2 · S1 · O · C · pledge dots |
| 6 IsarPunk | 4× A2 · S2–S5 · H · D (2 lots) · shop crib |
...
| **Measure sheet ×2** | Same layout — In and Out (or photo + clear) | ☐ |
| **Personal colour dots** | ≥12 distinct colours · enough for ~15 rows ×2 + 2 pledges | ☐ |
| Sets S, O, H | Laminate, distinct stock | ☐ |
| Sets C, D | Consumable | ☐ |
...
| Measure sheet finalised DE | Draft in Miro — fix duplicate / B3 |
...
| Endings reached | Mission boards |
